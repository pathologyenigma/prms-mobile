...
const CODE_PUSH_KEY = Platform.select({
	ios: '6ek5jS0zICD4h-oEa2ZjglyN-1AxnCYnHTFSL',
	android: 'kMiYPqqY2cITkSpC0gg4S97e1SaDq0H680IYQ'
})

export default class HTUpdateManager {

	static APPLICATION_VERSION = 2
	...
	static init = () => {
		...
		AppState.addEventListener('change', (nextState) => {
			if (AppState.currentState == 'background' && nextState == 'active') {
				this.update(false)
			}
		})
	}
	...
	// 				<View style={{ marginTop: 30, marginBottom: 10, width: '100%', height: 4, borderRadius: 4 / 2.0, overflow: 'hidden', alignSelf: 'center', backgroundColor: COLOR_ALPHA('#F95B78', 0.3) }}>
	// 					<Animated.View style={[StyleSheet.absoluteFill, { right: null, backgroundColor: '#FF3E61', width: Animated.multiply((SCREEN_WIDTH * 0.8 - 24 * 2), progressValue) }]}>
	// 					</Animated.View>
	// 				</View>
	// 			</View>
	// 		),
	...
	// 			progressBlock(receivedBytes / totalBytes, CodePush.SyncStatus.DOWNLOADING_PACKAGE)
	// 		}
	// 	}, 
	// 	(update) => {
