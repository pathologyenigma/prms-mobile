	...
	_renderNavigationBar = () => {
		return (
			<HTNavigationBar
				...
				rightItemList={[
					<Pressable style={styleList.navigationItemContainer} onPress={() => {
	...
	render() {
		return (
			<View style={styleList.container}>
				...
				<ScrollView style={styleList.container} onRefresh={() => this.forceUpdate()}>
					<HTCompanyContentPage initData={true} navigation={this.props.navigation} />
				</ScrollView>
