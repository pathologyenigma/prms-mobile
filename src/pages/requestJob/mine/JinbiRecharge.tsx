    ...
    return (
      <View style={{ marginTop: 4 }}>
        ...
        <ImageBackground
          ...
          <Text style={styles.tipsItem}>1、IOS充值金币不能在非IOS使用</Text>
          <Text style={styles.tipsItem}>2、兑换比例：1元=1金币</Text>
  ...
  renderFooterBtn() {
    ...
    return (
      <View style={styles.footerView}>
        ...
        <Text style={styles.moneyTitleValue}>{`¥ ${
          customAmount || '0'
        }元`}</Text>
        <GradientButton
